...
{
$pname=$_POST['Caption'];
$ptype=$_POST['Location'];	
$pimage=$_FILES["image"]["name"];
$email=$_SESSION['login'];
move_uploaded_file($_FILES["image"]["tmp_name"],"admin/pacakgeimages/".$_FILES["image"]["name"]);
$sql="INSERT INTO post(caption,location,image,userid) VALUES(:pname,:ptype,:pimage,'$email')";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="Caption" id="packagename" placeholder="Caption" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Location</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="Location" id="packagetype" placeholder=" Location" required>
									</div>
								</div>
