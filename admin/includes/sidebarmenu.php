					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="manage-posts.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Posts</span><div class="clearfix"></div></a></li>
									<li><a href="manage-blogs.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Blogs</span><div class="clearfix"></div></a></li>
