...
<html>
<head>
<title>TRAVELBOOK | Admin Dashboard</title>
				...
				<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								...
								<?php $sqlp = "SELECT postid from post";
$queryp = $dbh -> prepare($sqlp);
$queryp->execute();
$resultsp=$queryp->fetchAll(PDO::FETCH_OBJ);
$cntp=$queryp->rowCount();
					?>			<h4> <?php echo htmlentities($cntp);?> </h4>
				...
				<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								...
								<?php $sqlb = "SELECT blogid from blog";
$queryb = $dbh -> prepare($sqlb);
$queryb->execute();
$resultsb=$queryb->fetchAll(PDO::FETCH_OBJ);
$cntb=$queryb->rowCount();
					?>			<h4> <?php echo htmlentities($cntb);?> </h4>
